...
public class Benchmark {
    ...
    private static final NewGroovySerializerImpl newGroovySer = new NewGroovySerializerImpl();
    ...
    private static final BoonSerializerImpl boonSer = new BoonSerializerImpl();
    ...
    @GenerateMicroBenchmark
    public void simpleTestNewGroovy() {
        mediumTest(newGroovySer);
    }
    ...
    @GenerateMicroBenchmark
    public void mediumTestNewGroovy() {
        mediumTest(newGroovySer);
    }
    ...
    @GenerateMicroBenchmark
    public void complexTestNewGroovy() {
        complexTest(newGroovySer);
    }

    @GenerateMicroBenchmark
    public void complexTestBoon() {
        complexTest(boonSer);
    }

    @GenerateMicroBenchmark
    public void javaObjectsTestGroovy() {
        javaObjectsTest(groovySer);
    }

    @GenerateMicroBenchmark
    public void javaObjectsTestJackson() {
        javaObjectsTest(jacksonSer);
    }

    @GenerateMicroBenchmark
    public void javaObjectsTestGson() {
        javaObjectsTest(gsonSer);
    }

    @GenerateMicroBenchmark
    public void javaObjectsTestNewGroovy() {
        javaObjectsTest(newGroovySer);
    }

    @GenerateMicroBenchmark
    public void javaObjectsTestBoon() {
        javaObjectsTest(boonSer);
    }
    ...
    void javaObjectsTest(DataSerializer serializer) {
        serializer.serialize(JAVA_OBJECTS);
    }
    ...
    private static Map<String, Object> generateMediumData() {
        try {
            ...
            Map<String, Object> place1 = new LinkedHashMap<String, Object>();
            place1.put("name", "home");
            place1.put("geo", "ec31e2c1acbbe1bee");
            place1.put("lastCheckin", new Date());
            Map<String, Object> place2 = new LinkedHashMap<String, Object>();
    ...
    private static List<Object> generateComplexData() {
        ...
        Map<String, Object> headers1 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers2 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message3 = new LinkedHashMap<String, Object>();
        message3.put("id", "4f16fc97d1e2d32371003f05");
        message3.put(
                "body",
                "\nAUSTIN AT THE CAPITOL\n701 EAST 11TH STREET\nAUSTIN, TX  78701\ntel: 512-478-1111\nfax: 512-478-3700\n\nHotel Information: http://marriotthotels.com/AUSDT\n\n\nARRIVAL CONFIRMATION:\n Confirmation Number:83929275\nGuests in Room: 3\nNAME: MR ERIC  BASS \nGuest Phone: 7138530977\nNumber of Rooms:1\nArrive: Sep 7 2001\nDepart: Sep 8 2001\nRoom Type: ROOM - QUALITY\nGuarantee Method:\n Credit card guarantee\n\n\nRATE INFORMATION:\nRate(s) Quoted in: US DOLLAR\nArrival Date: Sep 7 2001\nRoom Rate: 129.00  per night. Plus tax when applicable\nRate Program: LEISURE RATE\n\nSPECIAL REQUEST:\n NON-SMOKING ROOM, GUARANTEED\n 2 DOUBLE BEDS, GUARANTEED\n HIGH FLOOR, REQUEST NOTED\n \n\n\nPLEASE DO NOT REPLY TO THIS EMAIL \nAny Inquiries Please call 1-800-228-9290 or your local\ninternational toll free number.\n \nConfirmation Sent: Mon Jul 30 15:45:05 2001\n\nLegal Disclaimer:\nThis confirmation notice has been transmitted to you by electronic\nmail for your convenience. Marriott's record of this confirmation\nnotice is the official record of this reservation. Subsequent\nalterations to this electronic message after its transmission\nwill be disregarded.\n\nMarriott is pleased to announce that High Speed Internet Access is\nbeing rolled out in all Marriott hotel brands around the world.\nTo learn more or to find out whether your hotel has the service\navailable, please visit Marriott.com.\n\nEarn points toward free vacations, or frequent flyer miles\nfor every stay you make!? Just provide your Marriott Rewards\nmembership number at check in.? Not yet a member?? Join for free at\nhttps://member.marriottrewards.com/Enrollments/enroll.asp?source=MCRE\n\n");
        message3.put("filename", "33.");
        Map<String, Object> headers3 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message4 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers4 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message5 = new LinkedHashMap<String, Object>();
        message5.put("id", "4f16fc97d1e2d32371003f3f");
        message5.put(
                "body",
                "thanks\n\n\n\n\nEdward D Gottlob\n04/09/2001 10:36 AM\nTo: Eric Bass/HOU/ECT@ECT\ncc:  \nSubject: FW: Check this out.\n\n\n---------------------- Forwarded by Edward D Gottlob/HOU/ECT on 04/09/2001 \n10:36 AM ---------------------------\n\n\n\"Gottlob Jr, Donald W\" <GOTTLODW@bp.com> on 04/09/2001 10:24:25 AM\nTo: \"Williamson, Alvin G\" <WILLIAA7@bp.com>, \"Befort, August III\"  \n<Beforta@bp.com>, \"'Aunt Billie'\" <tejas@txcyber.com>, \"'Bill Larson'\"  \n<BillLarson@wyoming.com>, \"'coe/jay wk'\" <stubeco@aol.com>, \"'Craig Janek'\"  \n<craigjanek@aol.com>, \"'David Smith'\" <DS1020@aol.com>, \"Richardson Jr, \nDonald B\" <RICHARDB@bp.com>, \"'Ed'\" <egottlo@ect.enron.com>, \"'Hal'\" \n<Barrow4@Prodigy.net>, \"Hooter, Howard\" <HOOTERHL@bp.com>, \"Ivy, Ross A\" \n<Ivyra@bp.com>, \"'J Carter'\" <jcarter@utmb.edu>, \"'J Snider'\"  \n<john_snider@sgs.com>, \"Guyton, Jimmie V\" <GUYTONJV@bp.com>, \"'Jan Payne'\"  \n<jpayne@hydril.com>, \"'Jeff hm'\" <bayshore2@earthlink.net>, \"'jeff work'\"  \n<GottlobJW@2mawnr.usmc.mil>, \"'Jessie'\" <nowir1x1@aol.com>, \"'John Garza'\"  \n<ajgarza@msn.com>, \"Geddes, John T\" <GEDDESJT@bp.com>, \"Clark, Ken\"  \n<CLARKRK@bp.com>, \"Payne, Kenneth M\" <PAYNEKM@bp.com>, \"'koral'\"  \n<kkypreos@yahoo.com>, \"'Kyle'\" <kyle.johnston@anico.com>, \"Frank, Larry J\"  \n<FRANKLJ@bp.com>, \"'Leigh'\" <LeighRV@aol.com>, \"'louie'\"  \n<trochesset@aol.com>, \"'lynn'\" <ljamail@galvestoncvb.com>, \"Painter, Martin \nD\" <PAINTEMD@bp.com>, \"'melinda'\"  <mlgarlan@email.utmb.edu>, \"Lozano, \nMichael A\" <LOZANOMA@bp.com>, \"'paul hm'\" <pwhitewing@aol.com>, \"'paul wk'\" \n<pwhiteman@endurosys.com>, \"Eames, Richard D\" <eamesrd@bp.com>, \"'R.Novelli'\" \n<ross@txlending.com>, \"Pinder, Charles R\" <PINDERCR@bp.com>, \"'Raul'\" \n<rrcastro@utmb.edu>, \"Moseley, Robert L\" <MOSELERL@bp.com>, \"'Ronnie'\" \n<rch965@aol.com>, \"'s garza'\" <sgarza@endurosys.com>, \"Tenhaaf, Stephen P.\" \n<tenhaasp@bp.com>, \"'stacey'\" <sgottlob@utmb.edu>, \"Douat, Stephen F\" \n<DOUATSF@bp.com>, \"'steve levy'\" <slevy@wt.net>, \"'susan garza'\" \n<segw99@aol.com>, \"'Tina (wk)'\" <Tina.walker@tdh.state.tx.us>, \"Fox, Vernon \nD\"  <FOXVD@bp.com>, \"Daley, Vicki R\" <DALEYVR@bp.com>, \"Blundell, Wayne\"  \n<BLUNDENW@bp.com>, \"Larson, William L\" <LARSONWL@bp.com>\ncc:  \nSubject: FW: Check this out.\n\n\n\n?\n-----Original Message-----\nFrom: Barnes, Mark T  \nSent: Saturday, March 17, 2001 03:29\nTo: Gottlob Jr, Donald  W; Evans, Jay\nSubject: FW: Check this out.\n\n\n\n\n?\n - HAPPY.EXE\n\n\n\n");
        message5.put("filename", "1042.");
        Map<String, Object> headers5 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message6 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers6 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message7 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers7 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message8 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers8 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message9 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers9 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> message10 = new LinkedHashMap<String, Object>();
        ...
        Map<String, Object> headers10 = new LinkedHashMap<String, Object>();
    ...
    private static final List<?> JAVA_OBJECTS = generateJavaObjects();

    private static List<?> generateJavaObjects() {
        Random rnd = new Random(System.currentTimeMillis());
        List<User> result = new ArrayList<User>();

        // Simple fields
        for (int i = 0; i < 50; i++) {
            User user = new User(Long.toHexString(rnd.nextLong()), "UserDisplayName" + i, "UserFirstName" + i, "UserLastName" + i,
                    rnd.nextInt(1), "photo/" + Long.toHexString(rnd.nextLong()) + ".png", "UserDisplayName" + i + "@mail.com",
                    Locale.getAvailableLocales()[rnd.nextInt(Locale.getAvailableLocales().length)].getDisplayCountry(),
                    new Date(System.currentTimeMillis() - rnd.nextInt(100000)), rnd.nextBoolean());
            result.add(user);
        }
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            while (user.getFriends().size() < 10) {
                User rndUser = result.get(rnd.nextInt(result.size()));
                if (!rndUser.equals(user) && !user.getFriends().contains(rndUser)) {
                    user.getFriends().add(new User(rndUser));
                }
            }
            user.setFollowers(new ArrayList<User>());
            while (user.getFollowers().size() < 20) {
                User rndUser = result.get(rnd.nextInt(result.size()));
                if (!rndUser.equals(user) && !user.getFollowers().contains(rndUser)) {
                    user.getFollowers().add(new User(rndUser));
                }
            }
        }
...
class User {
    ...
    public User(String id, String displayName, String firstName, String lastName, Integer gender, String photoId,
            String email, String location, Date createDate, Boolean locked) {
