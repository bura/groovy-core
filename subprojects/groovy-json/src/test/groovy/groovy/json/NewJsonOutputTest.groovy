...
import static groovy.json.NewJsonOutput.toJson
 ...
 */
class NewJsonOutputTest extends GroovyTestCase {
...
//        assert toJson("/") == '"\\/"'
    ...
    void testPrettyPrint() {
        ...
        // FIXME
        assert NewJsonOutput.prettyPrint(json.toString()) == """\
            {
                "trends": {
                    "2010-06-22 17:20": [
                        {
    ...
    void testPrettyPrintStringZeroLen() {
        ...
        // FIXME
        def result   = stripWhiteSpace( NewJsonOutput.prettyPrint(new JsonBuilder( tree ).toString()) )
    ...
    void testSerializePogos() {
        ...
        // FIXME
        assert NewJsonOutput.prettyPrint(JsonOutput.toJson(city)) == '''\
            {
                "name": "Paris",
                "districts": [
                    {
